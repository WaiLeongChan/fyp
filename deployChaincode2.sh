...
# Modified by my own
CC_SRC_PATH="./artifacts/src/github.com/simple_sc_2/go"
CC_NAME="simple_sc_2"
...
queryInstalled() {
    ...
    echo "===================== Query installed successful on peer0.org1 on mychannel2 ===================== "
}
...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses localhost:11051 --tlsRootCertFiles $PEER0_ORG3_CA \
        -c '{"function": "createCar","Args":["{\"id\":\"3\",\"make\":\"Tester\",\"addedAt\":1600138309939,\"model\":\"R8\", \"color\":\"red\",\"owner\":\"pavan\"}"]}'
